...
(function() {
    ...
    AreaRestriction.setBounds = function(map, bounds){
        ...
        //_map.addEventListener("zoomend", this._mapMoveendEvent1);
    ...
    AreaRestriction._mapMoveendEvent1 = function(e) {
        // 如果当前完全没有出界，则无操作
		//alert(_bounds.containsBounds(_map.getBounds()));
        if (_bounds.containsBounds(_map.getBounds())) {
            return;
        }
    ...
    AreaRestriction.clearBounds = function(){
        ...
        //_map.removeEventListener("zoomend", this._mapMoveendEvent1);
