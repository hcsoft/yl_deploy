...
//            });
//        }
//        this.fromStore.on('add', this.valueChanged, this);
//        this.fromStore.on('remove', this.valueChanged, this);
//        this.fromStore.on('load', this.valueChanged, this);
        ...
        p.render(this.el);
        //alert(dwr.util.toDescriptiveString(this.fromMultiselect,2));
