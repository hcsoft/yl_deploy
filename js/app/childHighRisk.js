...
app.childHighRiskPanel = new Ext.tf.HighRiskPanel({
  treeLoaderFn: UserMenuTreeService.getUserDistrictNodes,
  queryUrl : UserMenuTreeService.findChildHighRiskRecords,
  dataExportUrl : DataExportService.dataExportByChildHighRisk,
  gridViewConfig : {
  	forceFit : true,
  ...
  panelId : 'app.childHighRiskPanel',
  title: '高危儿童档案信息',
  ...
  gridCmConfig :
                 [{
                   ...
                   { "header" : "最近一次体检时间", "dataIndex" : "lastExamDate" ,
                	   "renderer": Ext.util.Format.dateRenderer('Y-m-d')}, 
...
ModuleMgr.register(app.childHighRiskPanel);
