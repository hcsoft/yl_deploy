...
app.healthfileTransferPanel = new Ext.tf.HealthTransferLoginOffPanel({
	treeLoaderFn : UserMenuTreeService.getUserDistrictNodes,
	queryUrl : UserMenuTreeService.getTransferHealthfile,
	panelId : 'healthfileTransfer',
	type : 0,
	flowType : '0',
	gridId : 'healthfileTransferGridId',
	title : '居民健康档案',
...
_tab = ModuleMgr.register(app.healthfileTransferPanel);
