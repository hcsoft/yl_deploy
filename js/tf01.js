...
Ext.tf.SimplePanel = Ext.extend(Ext.Panel, {
  ...
  f_edit : function(record) {
	    ...
	    var homeId = $('#homeId input').val();
	    var household = escape($('#household input').val());
	    var param = '?' + this.recordPk + '=' + fileNo + '&homeId=' + homeId + '&household=' + household;
...
//            alert(o);
    ...
    this.addRecord = function() {
        ...
        param = this.detailUrl + '?districtNumber=' + districtNumber + '&township=' + township 
        	+ '&village=' + village + '&homeId=' + homeId + '&household=' + household;
